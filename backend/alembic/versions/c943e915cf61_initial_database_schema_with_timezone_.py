...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "ocr_structured", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_receipt_processing_status"),
        "receipt",
        ["processing_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_receipt_store_chain"), "receipt", ["store_chain"], unique=False
    )
    op.create_table(
        "product_master",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "min_stock_quantity", sa.Numeric(precision=10, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_product_master_canonical_name"),
        "product_master",
        ["canonical_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_product_master_category"), "product_master", ["category"], unique=False
    )
    op.create_index(
        op.f("ix_product_master_id"), "product_master", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_product_master_off_product_id"),
        "product_master",
        ["off_product_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "initial_quantity", sa.Numeric(precision=10, scale=2), nullable=False
        ),
        sa.Column(
            "current_quantity", sa.Numeric(precision=10, scale=2), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_inventory_item_expiry_date"),
        "inventory_item",
        ["expiry_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_inventory_item_product_master_id"),
        "inventory_item",
        ["product_master_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_inventory_item_receipt_id"),
        "inventory_item",
        ["receipt_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_inventory_item_status"), "inventory_item", ["status"], unique=False
    )
    op.create_table(
        "shopping_list_item",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_shopping_list_item_id"), "shopping_list_item", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_shopping_list_item_is_purchased"),
        "shopping_list_item",
        ["is_purchased"],
        unique=False,
    )
    op.create_index(
        op.f("ix_shopping_list_item_priority"),
        "shopping_list_item",
        ["priority"],
        unique=False,
    )
    op.create_index(
        op.f("ix_shopping_list_item_product_master_id"),
        "shopping_list_item",
        ["product_master_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_shopping_list_item_source"),
        "shopping_list_item",
        ["source"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_store_product_alias_barcode"),
        "store_product_alias",
        ["barcode"],
        unique=False,
    )
    op.create_index(
        op.f("ix_store_product_alias_id"), "store_product_alias", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_store_product_alias_product_master_id"),
        "store_product_alias",
        ["product_master_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_store_product_alias_receipt_name"),
        "store_product_alias",
        ["receipt_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_store_product_alias_store_chain"),
        "store_product_alias",
        ["store_chain"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "quantity_consumed", sa.Numeric(precision=10, scale=2), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_consumption_log_action"), "consumption_log", ["action"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_consumption_log_id"), "consumption_log", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_consumption_log_inventory_item_id"),
        "consumption_log",
        ["inventory_item_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_consumption_log_logged_at"),
        "consumption_log",
        ["logged_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_consumption_log_product_master_id"),
        "consumption_log",
        ["product_master_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_consumption_log_product_master_id"), table_name="consumption_log"
    )
    op.drop_index(op.f("ix_consumption_log_logged_at"), table_name="consumption_log")
    op.drop_index(
        op.f("ix_consumption_log_inventory_item_id"), table_name="consumption_log"
    )
    ...
    op.drop_index(
        op.f("ix_store_product_alias_store_chain"), table_name="store_product_alias"
    )
    op.drop_index(
        op.f("ix_store_product_alias_receipt_name"), table_name="store_product_alias"
    )
    op.drop_index(
        op.f("ix_store_product_alias_product_master_id"),
        table_name="store_product_alias",
    )
    op.drop_index(op.f("ix_store_product_alias_id"), table_name="store_product_alias")
    op.drop_index(
        op.f("ix_store_product_alias_barcode"), table_name="store_product_alias"
    )
    op.drop_table("store_product_alias")
    op.drop_index(op.f("ix_shopping_list_item_source"), table_name="shopping_list_item")
    op.drop_index(
        op.f("ix_shopping_list_item_product_master_id"), table_name="shopping_list_item"
    )
    op.drop_index(
        op.f("ix_shopping_list_item_priority"), table_name="shopping_list_item"
    )
    op.drop_index(
        op.f("ix_shopping_list_item_is_purchased"), table_name="shopping_list_item"
    )
    ...
    op.drop_index(
        op.f("ix_inventory_item_product_master_id"), table_name="inventory_item"
    )
