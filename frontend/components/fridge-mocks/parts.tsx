/**
 * The drawn parts the fridge mocks share (Q17-M): chrome, glass shelves, drawers, door bins
 * and the odd bottle. All decoration - they sit inside a drawing that is `aria-hidden` - and
 * all coloured through Tailwind classes, so each has a light and a dark finish.
 */

import React from 'react'
import { roundedPath, type Box } from './shared'
